...
- [-] Testing [85%]
  ...
  - [X] Comandos
    ...
    - [X] Término de busqueda
  - [X] Comportamiento de inicio
    - [X] Estado inicial
    - [X] Ejecutar comando al inicio
    - [X] Retardo
  - [X] Comportamiento del toggle
    - [X] Acción al hacer click
      - [X] Alternar
      - [X] Siempre activado
      - [X] Siempre desactivado
    - [X] Mostrar indicador
    - [X] Cerrar el menú al presionar
    - [X] Verificar código de salida
  - [X] Sincronización
    - [X] Mantener sincronizado
    - [X] Frecuencia
  - [X] Atajo de teclado
