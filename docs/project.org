...
** PROJECT (objetivos específicos) [0%] [0/4]
...
**** IN-PROGRESS Panel Corners [0/1] :topbar:
- Descripción:
...
**** TODO User Avatar In QuickSettings [0/1] :quicksettings:
  - Descripción
  ...
  - [ ] ? 
**** NEXT Workspace Indicator [0/0] :topbar:widgets:
- Descripción
