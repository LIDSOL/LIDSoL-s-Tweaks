...
*** IN-PROGRESS Core
*** IN-PROGRESS Utils
*** IN-PROGRESS Módulos [3/11] [27%]
**** TODO Battery Bar :topbar:
...
**** TODO Date Menu (dinámico) :topbar:
...
- [X] Quick Settings
- [X] Overlay Mode
**** IN-PROGRESS Quick Text [1/4] :shell:
...
**** IN-PROGRESS Workspace Indicator [1/4] :topbar:
...
- [ ] Añadir animaciones de transición cuando se cambia de espacio de trabajo.
  - [ ] Animación similar a la píldora nativa.
