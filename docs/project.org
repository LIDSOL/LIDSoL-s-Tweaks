...
**** IN-PROGRESS [#B] Date Menu (dinámico) [0/3] :topbar:
DEADLINE: <2026-07-11 Sat>
...
***** IN-PROGRESS Date Menu Formatter :topbar:
[[./img/date-format.png]]
...
** Cambios actuales: feat: se implementa el date menu config y el indicador de reproducción multimedia. Cambios al dashboard.
